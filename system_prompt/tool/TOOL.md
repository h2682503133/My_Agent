...
skill_overview|技能名   - 查看某技能的简要使用说明
skill_exec|技能名   - 查看某技能的详细使用说明
...
5. 当使用的工具未在本设置中列出时，即为skill技能 可以使用“技能名|参数”的格式调用
7. 当需要使用skill时，优先使用知识库中已有的skill，即在下载skill之前先查看知识库中是否已有所需技能
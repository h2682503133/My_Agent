...
2. 当输出为技能介绍时，说明该技能无法使用该方法调用，请按输出内容调用
3. 所有的技能下载均通过clawhub完成，包括下载与可下载技能的搜索
4. viking知识库中已有技能即为本地已经下载的技能
5. 当需要使用skill时，优先使用知识库中已有的skill
6. 当下载或使用某skill之前先查看知识库中是否已有所需技能